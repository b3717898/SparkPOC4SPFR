...
public class CheckBillTaskEvolve {
...
//ALL,ALI,WX
    public CheckBillTaskEvolve(String taskid, String channel, Integer startDate, Integer endDate) {
        this.taskid = taskid;
    ...
    public void start() throws Exception {
        String log = String.format("taskid:%s,channel:%s,startDate:%d,endDate:%d Evolove",taskid,
                channel,startDate,endDate);
        this.doLog(log + " Evolove starting...");
...
//                            System.out.println("aliTuple4.count:" + aliTuple4.count());
                            this.doDetailCheckEvolove(bohTuple4_ali,aliTuple4,index);
                        }
...
//                            System.out.println("wxTuple4.count:" + wxTuple4.count());
                            this.doDetailCheckEvolove(bohTuple4_wx,wxTuple4,index);
...
//                    String.valueOf(rdd._7()),String.valueOf(rdd._8()),System.getProperty("line.separator")))));
    ...
    private void doDetailCheckEvolove(
                               JavaPairRDD<Tuple4<String,Integer,String,String>,CheckResult> bohTuple4,
                               JavaPairRDD<Tuple4<String, Integer, String, String>, CheckResult> threeRDTuple4,
                               Integer bizDate) throws  Exception{
        //5.1 记录明细比较结果
        StringBuffer sb = new StringBuffer();
        bohTuple4.union(threeRDTuple4).reduceByKey(CheckResult::diff).filter(r->r._2.sales!=0).mapToPair(m ->
                new Tuple2<>(new Tuple4<>(m._1._1(),m._1._2(),m._1._3(),m._1._4()),
                        new CheckResult(
                                ((m._2.source.equals("ALI") || m._2.source.equals("WX"))?-1:m._2.count),
                                m._2.sales,m._2.source))
        ...
        System.out.println("bohTuple4.union(threeRDTuple4).end:" + bizDate);
